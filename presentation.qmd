...
:::
::: {.column width="48%"}
![](images/SET-software-chorus.png){fig-align="center" width="100%"}
:::
:::
...
## The Exposome Cascade: Source-to-Outcome Framework

![](images/Exposome-Cascade.png){fig-align="center" height="320"}

**Why a source-to-outcome approach?**

- Environmental sources → ambient concentrations → internal exposures → biological responses → health outcomes
- Traditional paradigm: **one pollutant, one outcome**, cross-sectional
- Modern challenge: **multi-source, multi-pathway, multi-scale** complexity
- Requires harmonized data pipelines, scalable computation, and validated statistical models

**Our research spans the full cascade:**

- 📥 **Data** — standardized, harmonized geospatial inputs (amadeus)
- ⚙️ **Computation** — parallel processing at national scale (chopin)
- 📊 **Exposure models** — spatiotemporal GP & ensemble ML (PrestoGP, beethoven)
- 🧬 **Risk modeling** — mixture toxicology to population risk (GeoTox)
- 🏥 **Health outcomes** — wildfire smoke × immune disease (hcup_ap)

::: {.notes}
The Exposome Cascade is the conceptual framework unifying all the tools and methods we'll discuss. The key insight is that answering "how does pollution affect health?" requires being rigorous at every stage of this chain — data access, exposure estimation, and epidemiologic analysis.
:::
...
# Developing Accessible Geospatial Methods and Data {.section-title background-color="#2d6a4f"}
...
::: {.columns}
::: {.column width="50%"}
![amadeus](images/MessierK_24-2843_R-Package_Hex_Sticker_amadeus.png){width=160 fig-alt="amadeus hex logo"}
**amadeus** — Geospatial data access & processing for 17+ environmental datasets
`CRAN · github.com/NIEHS/amadeus`

![chopin](images/MessierK_24-2843_R-Package_Hex_Sticker_chopin.png){width=160 fig-alt="chopin hex logo"}
**chopin** — Parallel spatial computation via hierarchical partitioning
`CRAN · rOpenSci · github.com/ropensci/chopin`
:::
::: {.column width="50%"}
![beethoven](images/MessierK_24-2843_R-Package_Hex_Sticker_beethoven.png){width=160 fig-alt="beethoven hex logo"}
**beethoven** — Reproducible ensemble air quality modeling pipeline
`github.com/NIEHS/beethoven`

![GeoTox](images/GeoToxHex.png){width=160 fig-alt="GeoTox hex logo"}
**GeoTox** — Source-to-outcome chemical mixture risk modeling
