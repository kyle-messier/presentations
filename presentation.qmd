...
# Background {.section-title background-color="#518611"}
...
# The Exposome Cascade: Source-to-Outcome Framework {.section-title background-color="#518611"}
...
::: {style="background-color: #f8f9fa; border: 2px solid #518611; border-radius: 15px; padding: 25px; text-align: center; max-width: 85%; box-shadow: 0 4px 6px rgba(0,0,0,0.1);"}
...
::: {style="background-color: #f8f9fa; border: 2px solid #518611; border-radius: 15px; padding: 20px; text-align: center; max-width: 85%; box-shadow: 0 4px 6px rgba(0,0,0,0.1); font-size: 0.85em;"}
...
![](images/GeoTox.png){fig-align="center" height="600"}

<!-------------------------------------------------------------------------->
<!--------------------------------------------------------------------------->

## GeoTox as an extensible, flexible modeling framework
...
<!-------------------------------------------------------------------------->
<!--------------------------------------------------------------------------->
# Developing Accessible Geospatial Methods and Data {.section-title background-color="#518611"}
...
# Amadeus: Democratizing Geospatial Data Usage {.section-title background-color="#518611"}
...
# PrestoGP: Scalable Spatiotemporal GP {.section-title background-color="#518611"}
...
# chopin: Parallel Spatial Computation {.section-title background-color="#518611"}
...
# beethoven: Ensemble Air Quality Pipeline {.section-title background-color="#518611"}
...
# GeoTox: Source-to-Outcome Risk Assessment {.section-title background-color="#518611"}
...
# Conclusions {.section-title background-color="#518611"}
