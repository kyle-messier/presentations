...
<div style="display:flex; align-items:flex-start; justify-content:center; gap:0; padding:30px 0 10px 0; font-family:sans-serif;">

  <div style="text-align:center; width:220px;">
    <div style="background:#4B9CD3; border-radius:12px; padding:15px 10px; color:white; font-weight:bold; font-size:0.95em; min-height:80px; display:flex; align-items:center; justify-content:center; line-height:1.3;">
      UNC Chapel Hill<br>ESE
    </div>
    <div style="margin-top:10px; font-size:0.8em; color:#444;">
      <strong>PhD</strong><br>Geostatistics &amp; BME<br>Spatial Exposure Modeling
    </div>
  </div>

  <div style="font-size:2.2em; color:#999; align-self:flex-start; margin-top:22px; padding:0 8px;">&#8594;</div>

  <div style="text-align:center; width:220px;">
    <div style="background:#00873E; border-radius:12px; padding:15px 10px; color:white; font-weight:bold; font-size:0.95em; min-height:80px; display:flex; align-items:center; justify-content:center; line-height:1.3;">
      Environmental<br>Defense Fund
    </div>
    <div style="margin-top:10px; font-size:0.8em; color:#444;">
      <strong>Postdoc</strong><br>Mobile Monitoring<br>Urban Air Quality
    </div>
  </div>
  ...
  <div style="text-align:center; width:220px;">
    <div style="background:#D73F09; border-radius:12px; padding:15px 10px; color:white; font-weight:bold; font-size:0.95em; min-height:80px; display:flex; align-items:center; justify-content:center; line-height:1.3;">
      Oregon State<br>University
    </div>
    <div style="margin-top:10px; font-size:0.8em; color:#444;">
      <strong>K99/R00</strong><br>Spatiotemporal Methods<br>Multi-pollutant Models
    </div>
  </div>
  ...
  <div style="text-align:center; width:220px;">
    <div style="background:#f8f8f8; border:2px solid #00703C; border-radius:12px; padding:10px; min-height:80px; display:flex; align-items:center; justify-content:center;">
      <img src="images/NIEHS-4color-logo.png" style="max-height:58px; max-width:180px; object-fit:contain;">
    </div>
    <div style="margin-top:10px; font-size:0.8em; color:#444;">
      <strong>Stadtman Investigator</strong><br>Source-to-Outcome<br>Risk Assessment
    </div>
  </div>
...
::: {.columns}
::: {.column width="52%"}
![](images/Exposome-Cascade.png){fig-align="center" width="100%"}
:::
::: {.column width="48%"}
