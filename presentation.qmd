...
# PrestoGP: Scalable Spatiotemporal GP {.section-title background-color="#0d4b6b"}
...
# chopin: Parallel Spatial Computation {.section-title background-color="#2d6a4f"}
...
# beethoven: Ensemble Air Quality Pipeline {.section-title background-color="#7b4f9e"}
...
# GeoTox: Source-to-Outcome Risk Assessment {.section-title background-color="#c1440e"}
