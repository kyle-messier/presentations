...
| 3 | [**chopin**](https://docs.ropensci.org/chopin/) | Parallel spatial computation (rOpenSci) | Active |
| 4 | [**GeoTox**](https://niehs.github.io/GeoTox) | Source-to-outcome risk modeling framework | Active, CRAN |
| 5 | [**RGCA**](https://niehs.github.io/RGCA) | Reflected GCA for chemical mixture dose-response | WIP |
| 6 | [**PrestoGP**](https://niehs.github.io/PrestoGP/) | Scalable penalized spatiotemporal GP regression | WIP |

::: {.notes}
All packages on github.com/NIEHS. amadeus and GeoTox are on CRAN. chopin is rOpenSci certified.
:::
...
:::
::: {.column width="40%"}
*[Spatial partitioning diagram — placeholder]*
...
:::
::: {.column width="40%"}
*[beethoven hex logo — placeholder]*
...
| Package | CRAN | Repo |
|---------|------|------|
| amadeus | ✅ | NIEHS/amadeus |
| GeoTox | ✅ | NIEHS/GeoTox |
| chopin | ✅ | ropensci/chopin |
| beethoven | 🔄 WIP | NIEHS/beethoven |
| PrestoGP | 🔄 WIP | NIEHS/PrestoGP |
| RGCA | 🔄 WIP | NIEHS/RGCA |
| hcup_ap | — | NIEHS/hcup_ap |
...
:::
::: {.column width="40%"}
*[GeoTox framework diagram — placeholder]*
...
| `NIEHS/hcup_ap` | Wildfire × health outcomes |
