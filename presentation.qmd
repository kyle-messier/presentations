...
- 🎓 **PhD** — UNC Chapel Hill, Environmental Sciences & Engineering
  - Geostatistics, BME, spatiotemporal exposure modeling
...
- 🏔️ **Research Faculty** — Oregon State University (K99/R00)
  - Multi-pollutant spatiotemporal frameworks
  - Scalable GP methods (Vecchia approximation)
- 🏛️ **NIEHS** — Stadtman Tenure-Track Investigator
  - Source-to-outcome risk assessment
  - Open-source software for epi & tox community
:::
::: {.column width="45%"}
